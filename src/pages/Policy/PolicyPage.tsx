...
import { fetchSitePage, SitePage } from "../../services/api";

export function PolicyPage() {
  const [page, setPage] = useState<SitePage | null>(null);

  useEffect(() => {
    fetchSitePage("policy").then(setPage);
  }, []);
        ...
        <ScrollArea className="h-app">
          <div className="max-w-4xl mx-auto p-4 md:p-6 pt-20 space-y-6 pb-12">
            <div className="text-center space-y-3">
              <div className="flex justify-center mb-4">
                <div
                  ...
                  style={{
                    ...
                    boxShadow:
                      "0 0 50px rgba(255,182,193,0.8), inset 0 0 25px rgba(255,255,255,0.5)",
                  }}
                >
              ...
              <p className="text-pink-700">Cập nhật lần cuối: {page.updated_at?.slice(0, 10)}</p>
            </div>
            ...
            >
              <div className="whitespace-pre-line text-gray-700">{page.body}</div>
            </Card>
          </div>
        </ScrollArea>
      </div>
          ...
          >
            ...
            <div className="space-y-4 text-gray-700 text-ju">
              ...
              <div>
                ...
                <ul className="list-disc list-inside ml-4 mt-2 space-y-1 text-ju">
                <li> <strong>Lưu trữ Thiết yếu (Strictly Necessary):</strong> Đây là các dữ liệu bắt buộc để hệ thống hoạt động. Nếu thiếu chúng, bạn sẽ không thể đăng nhập hoặc sử dụng các tính năng bảo mật. Giúp hệ thống nhận diện bạn là ai sau khi đăng nhập, cho phép bạn truy cập vào các tính năng dành riêng cho thành viên như: Chatbot tư vấn chuyên sâu và Viết đánh giá.</li>
