...
export function FloatingChatbot() {
  ...
  return (
    <Card
      className={`fixed bottom-6 right-6 z-50 bg-gradient-to-br from-pink-50/98 via-rose-50/98 to-fuchsia-50/98 backdrop-blur-2xl border-2 border-pink-200 rounded-3xl shadow-2xl overflow-hidden transition-all duration-300 ${
