  ...
  return (
    <div className="min-h-dvh">
      <ScrollArea className="h-dvh">
        <div className="max-w-4xl mx-auto p-4 md:p-8 pt-10 space-y-6 pb-12">
          {/* Header */}
          <div className="text-center space-y-3">
            ...
            <h1 className="text-3xl sm:text-4xl font-semibold tracking-tight">Chính sách & Điều khoản</h1>
            <p className="text-muted-foreground text-base sm:text-lg max-w-3xl mx-auto">Cập nhật lần cuối: 08 tháng 12, 2025</p>
          </div>
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-lg font-semibold tracking-tight">Chính sách bảo mật</h2>
            </div>
            <div className="space-y-4 text-muted-foreground">
              <div>
                <h3 className="font-medium text-foreground mb-2">1. Thu thập thông tin</h3>
                <p>
              ...
              <div>
                <h3 className="font-medium text-foreground mb-2">2. Sử dụng thông tin</h3>
                <p>
              ...
              <div>
                <h3 className="font-medium text-foreground mb-2">3. Cam kết bảo mật</h3>
                <ul className="list-disc list-inside ml-4 mt-2 space-y-1">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-lg font-semibold tracking-tight">Điều khoản sử dụng</h2>
            </div>
            <div className="space-y-4 text-muted-foreground">
              <div>
                <h3 className="font-medium text-foreground mb-2">1. Chấp nhận điều khoản</h3>
                <p>
                  Khi sử dụng dịch vụ của chúng tôi, bạn đồng ý tuân theo các điều khoản và điều kiện được nêu dưới đây.
                </p>
              </div>
              <div>
                <h3 className="font-medium text-foreground mb-2">2. Tài khoản và Bảo mật</h3>
                <ul className="list-disc list-inside ml-4 mt-2 space-y-1">
              ...
              <div>
                <h3 className="font-medium text-foreground mb-2">3. Trách nhiệm người dùng</h3>
                <p>
              ...
              <div>
                <h3 className="font-medium text-foreground mb-2">4. Trách nhiệm của chúng tôi</h3>
                <p>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-lg font-semibold tracking-tight">Chính sách cookie & lưu trữ</h2>
            </div>
            <div className="space-y-4 text-muted-foreground">
              <div>
                <h3 className="font-medium text-foreground mb-2">1. Giới thiệu chung</h3>
                <p>
              ...
              <div>
                <h3 className="font-medium text-foreground mb-2">2. Các loại dữ liệu chúng tôi lưu trữ</h3>
                <ul className="list-disc list-inside ml-4 mt-2 space-y-1">
              ...
              <div>
                <h3 className="font-medium text-foreground mb-2">3. Quản lý và kiểm soát</h3>
                <ul className="list-disc list-inside ml-4 mt-2 space-y-1">
          ...
          >
            <h2 className="text-2xl font-semibold tracking-tight">Câu hỏi về chính sách</h2>
